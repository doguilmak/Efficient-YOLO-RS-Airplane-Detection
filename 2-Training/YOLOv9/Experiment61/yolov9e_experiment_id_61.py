# -*- coding: utf-8 -*-
"""YOLOv9e_Experiment_ID_61.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/115gmSfoo0bTimiy7LpKXUsb33W7YFlLV

# **Training HRPlane Dataset with YOLOv9e: Experiment No. 61**
...
|--|--|--|--|--|--|--|--|--|
| 100 | 640x640 | 16 | 0.001 | AdamW | 0 | 0 | 0 | 0 |
...
BASE_DIRECTORY = '/gdrive/MyDrive/Datasets/HRPlanes/YOLOV8/YOLOv9e/Experiment_No_61/' # @param {type:"string"}
...
--batch-size {BATCH} --epochs 100 --imgsz {IMAGE_SIZE} --device 0 \
...
image = mpimg.imread(f"{HOME}/yolov9/runs/train/exp/results.png")
